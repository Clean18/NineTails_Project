...
public class UpgradePopUp : BaseUI
{
	...
	public void UpdateText()
	{
        ...
        switch (equipmentData.Grade)
        {
            ...
            case "SSR": nextGradeText = $"가하는 피해\n{PlayerController.Instance.GetIncreseDamage(equipmentData.Level) * 100}% → {PlayerController.Instance.GetIncreseDamage(equipmentData.Level + 1) * 100}%"; break;
        }
        ...
        _increaseDamageText.text = $"가하는 피해 {PlayerController.Instance.GetIncreseDamage() * 100}% 증가";
